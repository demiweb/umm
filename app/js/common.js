...
const counters = [...document.querySelectorAll('.hero-text-wrap ul li span')];
const speed = 8000;
...
let sitesSlider = [...document.querySelectorAll('.certificates-cont')];
...
let partnersSlider = [...document.querySelectorAll('.partners-slider')];
